...
//  QuickPark
//
//  Created by manar . on 17/04/2022.
//
...
//    @IBOutlet weak var FavoutireView: UIView!
//    @IBOutlet weak var FavoutireViews: UITableView!
    var searching = false
    ...
    func setUI(){
        ...
        //FavoutireViews?.delegate = self
        //FavoutireViews?.dataSource = self
      
        //making table view look good
        ParkingsViews?.separatorStyle = .none
        ParkingsViews?.showsVerticalScrollIndicator = false
       // FavoutireViews?.separatorStyle = .none
       // FavoutireViews?.showsVerticalScrollIndicator = false
...
extension FavouriteListVC: UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate{
